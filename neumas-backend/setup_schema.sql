...
-- =============================================================================
-- This file is the original bootstrap script and is kept for historical reference only.
-- It is NOT authoritative. Do not edit this file. Do not run this for new deployments.
--
-- CANONICAL SCHEMA: neumas-backend/supabase/schema.sql
-- MIGRATIONS:       neumas-backend/supabase/migrations/
--
-- See docs/adr/001-canonical-schema-strategy.md for rationale.
-- =============================================================================
--
-- Neumas Database Schema Setup (LEGACY)
-- 
-- This script creates:
